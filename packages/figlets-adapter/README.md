...
- **Document a component** — generate a Figma spec sheet and markdown handoff
- **Full health check** — sync → detect → audit → semantic setup/accessibility QA → approved repair in one flow
