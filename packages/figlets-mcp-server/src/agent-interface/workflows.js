...
const DESIGNER_FLOW_HARD_RULES = {
  ...
  supportedBulkUpdateSurfaces: [
    ...
    "inspect_ds_setup_gaps.semanticNamingConflicts + designer's chosen convention → plan_ds_semantic_naming_consolidation, then approved repairPlan.applyInput → apply_ds_semantic_naming_consolidation for rename-only compatibility consolidation",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        designerMessage: "If semanticNamingConflicts remain and you choose surface-based or role-based naming, I'll produce a dry-run consolidation plan with exact canonical and duplicate variables.",
      },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        kind: "read",
        tool: "plan_ds_semantic_naming_consolidation",
        designerMessage: "If semanticNamingConflicts remain and you choose a canonical convention, I'll dry-run the exact safe rename plan.",
      },
      {
        id: "apply-approved-naming-consolidation",
        kind: "write",
