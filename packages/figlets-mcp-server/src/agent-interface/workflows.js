...
const DESIGNER_FLOW_HARD_RULES = {
  ...
  bulkRepairRouting: [
    ...
    "For config-backed missing typography, spacing, radius, border-width, or elevation tokens, use inspect_ds_token_gaps, then approved update_ds_tokens and apply_ds_foundation_repairs when foundationRepairPlan applies.",
