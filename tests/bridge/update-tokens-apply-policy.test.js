...
module.exports = (() => {
  ...
  assert.ok(receiver.includes("capability: 'foundation-repairs'"), "receiver should gate foundation repairs on advertised capability");
  ...
  assert.ok(receiver.includes("capability: 'semantic-naming-consolidation'"), "receiver should gate semantic naming consolidation on advertised capability");
  ...
  assert.ok(receiver.includes("capability: 'figma-operations'"), "receiver should gate figma operations on advertised capability");
  ...
  assert.ok(receiver.includes("capability: 'update-tokens'"), "receiver should gate token updates on advertised capability");
})();
